...
The GoCV package supports the latest release of OpenCV (v3.3.1) on Linux, OS X, and Windows. We hope to make the Go programming language a "first-class" client compatible with the latest developments in the OpenCV ecosystem.
