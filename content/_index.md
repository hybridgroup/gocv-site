...
The GoCV package supports the latest releases of Go and OpenCV v4.11.0 on Linux, macOS, and Windows. Our mission is to make the Go language a "first-class" client compatible with the latest developments in the OpenCV ecosystem.
